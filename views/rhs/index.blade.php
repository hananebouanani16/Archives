              ...
              <div class="iq-card-body">
                       <div id="table" class="table-editable">
                              ...
                              <div class="user-list-files d-flex float-right">
                                ...
                                <button class="btn btn-secondary dropdown-toggle ml-2" type="button" id="filterDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                  ...
                                  <div class="dropdown-menu" aria-labelledby="filterDropdown">
                                    <a class="dropdown-item" href="javascript:void(0);" onclick="filterTable('preuve')">Mariage</a>
                                    <a class="dropdown-item" href="javascript:void(0);" onclick="filterTable('renseignement')">Paternité</a>
                                    <a class="dropdown-item" href="javascript:void(0);" onclick="filterTable('expedition')">Décés</a>
                                </div>
                            </div>
                         ...
                         <table id="fonctions-table" class="table table-bordered table-responsive-md table-striped text-center">
                          ...
                          <tbody>
                            @foreach($documents as $document)
                            @if($filter === 'mariage' && $document->type === 'Evenement Familar')
                                <tr>
                                    <td>{{ $document->title }}</td>
                                    <td>{{ $document->creation_date }}</td>
                                    <td>
                            ...
                            @elseif($filter === 'décét' && $document->type === 'Evenement Familar')
                                <tr>
                                    <td>{{ $document->title }}</td>
                                    <td>{{ $document->creation_date }}</td>
                                    <td>
                            ...
                            @elseif($filter === 'paternité' && $document->type === 'Evenement Familar')
                                <tr>
                                    <td>{{ $document->title }}</td>
                                    <td>{{ $document->creation_date }}</td>
                                    <td>
