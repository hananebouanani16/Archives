    ...
    <div id="main">
        <div class="container">
            ...
            <div class="radio-group">
                <input type="radio" id="brq" name="type" value="BRQ" onchange="toggleFilter()">
                <label for="brq">BRQs</label>

            </div>
            <div class="radio-group">
                <input type="radio" id="decharge" name="type" value="decharge" onchange="toggleFilter()">
                <label for="decharge">Décharges</label>
            </div>

            <div class="radio-group">
        <input type="radio" id="pmt" name="type" value="PMT" onchange="toggleFilter()">
        <label for="pmt">PMTs</label>
    </div>
            <br>
