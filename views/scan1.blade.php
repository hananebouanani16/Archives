    ...
    <div id="main">
        <div class="container">
            ...
            <div class="radio-group">
                <input type="radio" id="preuvelivraison" name="type" value="preuve de livraison" onchange="toggleFilter()">
                <label for="preuvelivraison">Preuves de livraison</label>

            </div>
            <div class="radio-group">
                <input type="radio" id="fiherenseignement" name="type" value="fiche de renseignements" onchange="toggleFilter()">
                <label for="fiherenseignement">Fiche de renseignement</label>
            </div>
            <div class="radio-group">
                <input type="radio" id="fichexpedition" name="type" value="fiche expedition" onchange="toggleFilter('congeSansSold')">
...
<div class="form-group" id="dateExpirationField" style="display: none">
    ...
    <script type="text/javascript">
     ...
     function toggleFilter(selectedType) {
    var dateExpirationField = document.getElementById("dateExpirationField");

    if (selectedType === "congeSansSold") {
