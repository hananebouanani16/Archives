...
<body>
    <div id="main">
        <div class="container">
            ...
            <div class="radio-group">
                <input type="radio" id="contratemploye" name="type" value="contrat" onchange="toggleFilter()">
                <label for="contratemploye">Contrats employés</label>

            </div>
            <div class="radio-group">
                <input type="radio" id="passationdesconsignes" name="type" value="passation" onchange="toggleFilter()">
                <label for="passationdesconsignes">Passation des consignes</label>
            </div>
    ...
    <div class="radio-group">
        <input type="radio" id="Maladi" name="type" value="Maladi" onchange="toggleFilter()">
        <label for="Maladi">Maladie</label>
    </div>
