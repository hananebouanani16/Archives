            ...
            <div class="iq-card-header d-flex justify-content-between">
             <ul class="nav nav-pills mb-3 nav-fill" id="pills-tab-1" role="tablist" style="width: 100%; justify-content: space-between;">
              <li class="nav-item" style="width: 33.33%;">
                  <a class="nav-link active" id="pills-home-tab-fill" data-toggle="pill" href="#pills-home-fill" role="tab" aria-controls="pills-home" aria-selected="true">BRQs</a>
              </li>
              <li class="nav-item" style="width: 33.33%;">
                  <a class="nav-link" id="pills-profile-tab-fill" data-toggle="pill" href="#pills-profile-fill" role="tab" aria-controls="pills-profile" aria-selected="false">Décharges</a>
              </li>
              <li class="nav-item" style="width: 33.33%;">
                  <a class="nav-link" id="pills-contact-tab-fill" data-toggle="pill" href="#pills-contact-fill" role="tab" aria-controls="pills-contact" aria-selected="false">PMTs</a>
              </li>
          </ul>
            </div>
                ...
                <div class="iq-card-body">
                    <div class="tab-content" id="pills-tabContent-1">
                        ...
                        <div class="tab-pane fade" id="pills-profile-fill" role="tabpanel" aria-labelledby="pills-profile-tab-fill">
                            ...
                            <span class="table-add float-right mb-3 mr-2">
                                <div class="user-list-files d-flex float-right">
                                    <a class="btn btn-outline-success" href="{{ url('consultantsadd') }}">Scanner une décharge</a>
                                </div>
                            </span>
                        ...
                        <div class="tab-pane fade" id="pills-contact-fill" role="tabpanel" aria-labelledby="pills-contact-tab-fill">
                            ...
                            <span class="table-add float-right mb-3 mr-2">
                                <div class="user-list-files d-flex float-right">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <a class="btn btn-outline-success" href="{{ url('personnelsadd') }}">Scanner un PMT</a>
                                        <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
                                    </div>
                                </div>
                            </span>
