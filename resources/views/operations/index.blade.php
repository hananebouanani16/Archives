                ...
                <div class="iq-card-body">
                    <div class="tab-content" id="pills-tabContent-1">
                        <div class="tab-pane fade show active" id="pills-home-fill" role="tabpanel" aria-labelledby="pills-home-tab-fill">
                            ...
                            <span class="table-add float-right mb-3 mr-2">
                                <div class="user-list-files d-flex float-right">
                                    ...
                                    <a class="btn btn-outline-success" href="{{ route('scan1.page') }}">Scanner un fichier</a>                                        <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
                                    </div>
                                </div>
                            </span>
                        ...
                        <div class="tab-pane fade" id="pills-profile-fill" role="tabpanel" aria-labelledby="pills-profile-tab-fill">
                            ...
                            <span class="table-add float-right mb-3 mr-2">
                                <div class="user-list-files d-flex float-right">
                                <a class="btn btn-outline-success" href="{{ route('scan1.page') }}">Scanner un fichier</a>                                </div>
                            </span>
                        ...
                        <div class="tab-pane fade" id="pills-contact-fill" role="tabpanel" aria-labelledby="pills-contact-tab-fill">
                            ...
                            <span class="table-add float-right mb-3 mr-2">
                                <div class="user-list-files d-flex float-right">
                                    <div class="d-flex justify-content-between align-items-center">
                                    <a class="btn btn-outline-success" href="{{ route('scan1.page') }}">Scanner un fichier</a>
