...
<div id="content-page" class="content-page">
    ...
    <div class="container">
        <b><h5 style="color: #262BC0"> Modifier direction </h5></b>
        <div class="iq-card">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header" style=".iq-card-header margin-bottom: 1px;">
                                <h4>Fiche de modification des personnels</h4>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-4">
                                        ...
                                        <form action="{{ route('directions.update', $direction->ID_DR5) }}" method="POST">
                                                @csrf
                                           
                                                <!-- Champ caché pour l'ID du personnel -->
                                                ...
                                                <div class="form-group"  style="display:flex; flex-direction:row;align-items: center;">
                                                    <div class="form-group mr-2" >
                                                      ...
                                                      <input type="text" class="form-control" id="code_direction" name="code_direction" style="width: 290px;" value="{{ $direction->code_direction}}">
                                                  </div>
                                                  <div class="form-group mr-2">
                                                      <label class="type_direction_label" for="type_direction">Type</label>
                                                      <select name="type_direction" class="form-control" id="type_direction" value="{{ $direction->type_direction}}" style="width: 290px;height: 44px;">
                                                  ...
                                                  <div class="form-group mr-2">
                                                      ...
                                                      <select name="nom_parent" class="form-control" id="nom_parent" value="{{ $direction->nom_parent}}" style="width: 290px;height: 44px;"></select>
                                                  </div>
                                                  </div>
                                                  <script>
                                                  ...
                                                  <div class="form-group"  style="display:flex; flex-direction:row;align-items: center;">
                                                    <div class="form-group mr-2" >
                                                      ...
                                                      <input type="text" class="form-control" id="intitule_direction" name="intitule_direction" value="{{ $direction->intitule_direction}}" style="width: 290px;">
                                                    </div>
    ...
    <input type="text" class="form-control" id="adresse_direction" name="adresse_direction">
                                                    ...
                                                    <div class="form-group mr-2" >
                                                      ...
                                                      <input type="text" class="form-control" id="tel1_direction" name="tel1_direction" value="{{ $direction->tel1_direction}}" style="width: 290px;">
                                                    </div>
                                                    <div class="form-group mr-2" style="width: 300px;">
                                                      <label class="tel2_direction_label" for="tel2_direction">Tel2</label>
                                                      <input type="text" class="form-control" id="tel2_direction" name="tel2_direction" value="{{ $direction->tel2_direction}}" style="width: 290px;" >
                                                    </div>
                                                  </div>
                                                  <div class="form-group"  style="display:flex; flex-direction:row;align-items: center;">
                                                      <div class="form-group mr-2" >
                                                      <label class="fax_direction_label" for="fax_direction">Fax</label>
                                                      <input type="text" class="form-control" id="fax_direction" name="fax_direction" value="{{ $direction->fax_direction}}" style="width: 290px;">
                                                  </div>
                                                      <div class="form-group mr-2" >
                                                          <label class="email_direction_label" for="email_direction">Email</label>
                                                          <input type="email" class="form-control" id="email_direction" name="email_direction" value="{{ $direction->email_direction}}" style="width: 290px;">
                                                      </div>
                                                          <div class="form-group mr-2" >
                                                              <label class="responsable_direction_label" for="responsable_direction">Responsable</label>
                                                              <input type="text" class="form-control" id="responsable_direction"  name="responsable_direction" value="{{ $direction->responsable_direction}}" style="width: 290px;">
                                                            </div>
                                                      </div>
                                                      <div class="form-group"  style="display:flex; flex-direction:row;align-items: center;">
                                                      <div class="form-group mr-2">
                                                          <label class="memo_direction_label" for="memo_direction">Memo</label>
                                                          <input type="text" class="form-control" id="memo_direction" name="memo_direction" value="{{ $direction->memo_direction}}" style="width: 290px;">
                                                      </div>
                                                      <div class="form-group mr-2">
                                                          <label class="creer_le_direction_label" for="creer_le_direction">Créer le</label>
                                                        <input type="date" class="form-control" id="creer_le_direction" name ="creer_le_direction" value="{{ $direction->creer_le_direction}}" style="width: 290px;">
                                                      </div>
                                                      <div class="form-group mr-2" >
                                                          <label class="creer_par_direction_label" for="memo_direction">Créer par</label>
                                                        <input type="text" class="form-control" id="creer_par_direction" name="creer_par_direction"  value="{{ $direction->creer_par_direction}}" style="width: 290px;" >
                                                      </div>
                                                      </div>
                                                      <div class="form-group"  style="display:flex; flex-direction:row;align-items: center;">
                                                          <div class="form-group mr-2">
                                                        <label class="modifie_le_direction_label" for="modifie_le_direction">Modifier le</label>
                                                        <input type="date" class="form-control" id="modifie_le_direction" name="modifie_le_direction" value="{{ $direction->modifie_le_direction}}" style="width: 290px;" >
                                                      </div>
                                                      <div class="form-group mr-2">
                                                          <label class="modifie_par_direction_label" for="modifie_par_direction">Modifier par</label>
                                                        <input type="text" class="form-control" id="modifie_par_direction" name="modifie_par_direction" value="{{ $direction->modifie_par_direction}}" style="width: 290px;">
                                                      </div>
                                                      <div class="form-group mr-2">
                                                          <label class="mobile_direction_label" for="mobile_direction">Mobile</label>
                                                      <input type="text" class="form-control" id="mobile_direction" name="mobile_direction" value="{{ $direction->mobile_direction}}" style="width: 305px;" >
    ...
    @foreach($wilayas as $wilaya)
        <option value="{{ $wilaya->id_wilaya }}" 
                {{ (old('id_wilaya', optional($direction)->id_wilaya) == $wilaya->id_wilaya) ? 'selected' : '' }}>
            {{ $wilaya->nom_wilaya }}
        </option>
    @endforeach
</select>
                                                      ...
                                                      <button class="btn btn-success" type="submit" onclick="showSuccessAlert()">Modifier</button>
                                                    </form>
